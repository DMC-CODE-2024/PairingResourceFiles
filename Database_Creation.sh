...
INSERT INTO cfg_feature_alert (alert_id, description) VALUES ('alert2201', 'Missing value for Key: <CONFIG_KEY> for Feature:<FEATURE_NAME>'),('alert2206', 'Database Exception: <EXCEPTION>. for Feature:<FEATURE_NAME>');
